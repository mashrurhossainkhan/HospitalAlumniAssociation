...
const UserProfile = () => {
    ...
    const profileForm = () => (<form onSubmit={handleSubmit}>
        ...
        <button style={{float: 'right', color: '#404040', fontSize:'1.1vw'}} className="btn-danger btn-outline-danger btn-sm" onClick={deleteUser1(values)}>Delete my Profile</button> <br/>
        
        <hr/>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>Transaction ID: {TransactionID}</h3>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>Registration Date: {timeRemain}  </h3>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>Registration End Date: {finishYear}  </h3>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>User Status: {UserStatus}  </h3>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>Role: {role}  </h3>
        <h3 style={{ fontFamily: "unset", color: 'black', fontSize:'1vw'}}>User Type: {UserType}  </h3>
        <hr/>
