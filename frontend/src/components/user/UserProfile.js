...
const UserProfile = () => {
    ...
    const profileForm = () => (<form onSubmit={handleSubmit}>
        ...
        <button style={{float: 'right', fontFamily: 'sans-serif', color: 'black', fontSize:'1.5vw'}} className="btn-danger btn-outline-danger btn-sm" onClick={deleteUser1(values)}>Delete my Profile</button>
        ...
        <h3 style={{fontFamily: 'sans-serif', color: 'black', fontSize:'1.5vw'}}>Role: {role}  </h3>
        <h3 style={{fontFamily: 'sans-serif', color: 'black', fontSize:'1.5vw'}}>User Type: {UserType}  </h3>
