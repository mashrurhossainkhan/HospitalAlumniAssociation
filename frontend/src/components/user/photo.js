...
const Photo = () => {
   ...
   /* const handleChange = (e) => {
    ...
    const detailForm = () => (
        ...
        <i class="fa fa-cloud-upload" style={{color: "white"}}></i> Upload Your Photo
        </label>
        <input id="file-upload" type="file" style={{color: "white"}} name="photo" onChange={handleSubmit}/>
    </div>
    );
            ...
            <div className="row">
                <div className="col-md-8 offset-md-2">
                    ...
                    {showSuccess(success, 'Photo Added Successfully!')}
                     ...
                     <img src={`${API}/user/photos/${userInfo()._id}`} 
                     alt="Upload a Photo" 
