...
const Executive = () =>{
    ...
    useEffect(()=> {
        detailsHomePage("60f3c1389151b21308dc0ab2")
    ...
    return(        
        ...
        <a href="/details/60f3c1389151b21308dc0ab2"><button className="btn btn-info" style={{float: 'right', margin:"3vw"}}>See all</button></a>
        <main class="hoc container clear">   
          ...
          <figcaption className="center1" style={{paddingTop:"2vw"}}>
            ...
            <p className="heading underline font-x2">Excutive Member</p>
          </figcaption>
          </figure>
