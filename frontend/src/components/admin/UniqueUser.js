...
const UniqueUser = () => {
    ...
    useEffect(() => {
        ...
        getUserDetails(myArr[myArr.length - 1])
    ...
    const profileForm = () => (<form onSubmit={handleSubmit}>
        ...
        <h3 style={{textStyle: 'bold', fontFamily: '-moz-initial', color: '#404040', fontSize:'1.6vw'}} className="center">{name}</h3>
        <button style={{float: 'right', color: '#404040', fontSize:'1.1vw'}} className="btn-danger btn-outline-danger btn-sm" onClick={deleteUser1(values)}>Delete User</button> <br/>
        <hr/>
        
        <h3 style={{textStyle: 'bold', fontFamily: 'arial', color: 'black', fontSize:'1vw'}}>User ID: {_id}</h3>
        <h3 style={{textStyle: 'bold', fontFamily: 'arial', color: 'black', fontSize:'1vw'}}>Transaction ID: {TransactionID}</h3>
        <h3 style={{textStyle: 'bold', fontFamily: 'arial', color: 'black', fontSize:'1vw'}}>Registration Date: {timeRemain}  </h3>
        <h3 style={{textStyle: 'bold', fontFamily: 'arial', color: 'black', fontSize:'1vw'}}>Registration End Date: {finishYear}  </h3>
        <h3 style={{textStyle: 'bold', fontFamily: 'arial', color: 'black', fontSize:'1vw'}}>User Status: {UserStatus}  </h3>
    ...
    return (<>
        <Layout title="Profile" description="Doctor's Profile" className="container">
            <div className="container" >
                <div className="row" style={{backgroundColor: "white", padding: "5.5vw"}}>
                    <div className="col-md-12">
                    <a style={{textDecoration: "none"}} href="/admin/dashboard">Dashboard/</a>
                    <a style={{textDecoration: "none"}} href="/allusers">AllUsers</a> <br/>
